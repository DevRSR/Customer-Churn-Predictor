...
- **Improvement of services**: Build infrastructure that will improve call quality and overall services of the company will reduce customer complains by over 55% thereby increasing the company revenue by over $30000 which are lost through customer churn.
- **Improvement of technical support**: Having Good technical support that act promptly and efficient to customers needs will not only retain the customers but also make the company to be at tip of their lips making referral easy and inorganic which will increase their customer base and subcequently increases their revenue.
- **Welcome back bonus**: Data has shown that inactive customers rarely come back to use the service rather they churn the telecom company leading to a loss of $35000 in revenue. Introducing a welcome back bonus to attract them to the service will not only reduce revenue loss but also increase the revenue due to increase in service used.
